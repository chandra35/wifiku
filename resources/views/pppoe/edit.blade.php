    ...
    <div class="card card-danger">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('pppoe.destroy', $pppoe->id) }}" method="POST" style="display: inline;" 
                  class="delete-pppoe-form" data-pppoe-name="{{ $pppoe->name }}">
                @csrf
                @method('DELETE')
                <button type="button" class="btn btn-danger delete-pppoe-btn">
...
@section('js')
    ...
    $(document).ready(function() {
        ...
        // SweetAlert2 Delete PPPoE
        $('.delete-pppoe-btn').click(function(e) {
            e.preventDefault();
            const form = $(this).closest('.delete-pppoe-form');
            const pppoeName = form.data('pppoe-name');
            
            Swal.fire({
                title: 'Konfirmasi Hapus PPPoE Secret',
                html: `Apakah Anda yakin ingin menghapus PPPoE secret <strong>"${pppoeName}"</strong>?<br><br>
